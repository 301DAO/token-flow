        ...
        <div className="flex flex-col">
          {strategies.map((strategy, index) => {
            return (
              <div
                key={index}
                id={`node-connect-${index}`}
                className="mx-2 my-1 rounded-lg px-5 py-5 shadow bg-gray-200"
              >
                <Select
                  id="alert-type"
                  value={strategy.alertType || 'DEFAULT'}
                  onChange={(event) => {
                ...
                >
                  ...
                  <MenuItem value={AlertType.EPNS} disabled>
                    EPNS (Work in progress)
                  </MenuItem>
