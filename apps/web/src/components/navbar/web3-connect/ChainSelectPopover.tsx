...
function ChainSelectPopover(props: {}) {
    return (
        <div className="flex flex-col mt-3 rounded-lg bg-primary-alt shadow w-60 pb-4">
            ...
            <NetworkSelect
                selected={false}
                networkName="Polygon"
                networkLogoPath="/polygon-logo.webp"
            />
            <NetworkSelect
                selected={false}
                networkName="Optimism"
                networkLogoPath="/optimism-logo.svg"
            />
            <NetworkSelect
                selected={false}
                networkName="Arbitrum"
                networkLogoPath="/arbitrum-logo.webp"
            />
        </div>
    );
}
